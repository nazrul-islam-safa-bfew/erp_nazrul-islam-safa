...
{
echo "<table align=center border=1 cellspacing=0 cellpading=0 style='border-collapse: collapse' bordercolor=#FF0000>
<tr><td background=../images/tbl_error.png><font color=#FFFFFF> ERROR</font></td>".
"</tr>".
"<tr><td>$un<br>".
