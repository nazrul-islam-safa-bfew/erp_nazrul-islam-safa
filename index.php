...
$locPath = $_SERVER["DOCUMENT_ROOT"]."/erp";
include($locPath."/includes/session.inc.php");
include($locPath."/includes/config.inc.php");
include($locPath."/includes/myFunctionTest.php");
//include($locPath."/includes/myFunction.php"); // some general function
//echo "erp";
if($_GET["S"])
	$_SESSION["S"]=1;
// echo $_SESSION["S"];
...
//include_once($locPath."/includes/myFunction1.php"); // some general function
include_once($locPath."/includes/accFunction.php"); //all accounts function
//include_once($locPath."/includes/empFunction.inc.php"); //manpower function
//include_once($locPath."/includes/eqFunction.inc.php"); // equipment function

include_once($locPath."/includes/subFunction.inc.php"); // sub contracts function

//include_once($locPath."/includes/matFunction.inc.php"); // material function

include_once($locPath.'/includes/vendoreFunction.inc.php'); // vendor related function
require_once($locPath."/keys.php"); // created and powered by function and link
