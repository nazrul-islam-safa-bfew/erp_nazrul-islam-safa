...
while($re=mysqli_fetch_array($sqlrunp)){
 ...
 <tr>
   ...
   <td style="	border-bottom: 0px;" align="right"><input type="text" size="10" alt="cal" onchange="disableSave(this.form);" name="examount<? echo $i;?>" value="<? echo $re['rate'];?>" style="text-align:right"
