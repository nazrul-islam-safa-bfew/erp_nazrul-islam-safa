...
<table width="<?php echo $width; ?>"  align="center" border="1" bordercolor="#9999CC" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
	...
	function printRevisionTxt($no=null,$txt=null,$bk=null){
		...
		$listdata[]=[$valDate,"<tr><td width=\"110\">R:$no, <small>$valDate</small> </td><td><font class=\"\">$key $bk</font> <font class=\"\"> $val</font></td></tr>"];
	}
...
// 	echo $revSql;
	...
	while($rowDaily=mysqli_fetch_array($qDaily)){
		...
		$listdata[]=[$strDate,"<tr><td width=\"110\"><small>$strDate</small> </td><td><b class=\"\">Site Engn:</b> <font class=\"\"> $rowDaily[clientdes]</font></td></tr>"];
	}
